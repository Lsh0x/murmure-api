...
| --- | --- | --- |
| `murmure-lib/` | Core library with transcription engine, audio processing, dictionary, and model management | Shared library used by server and examples |
